...
//import { sendEmail } from "../../../../payment/services/paymentServices";
...
export default function AddCustomerPayment() {
  ...
  const cusEmail = localStorage.getItem("mail")
  ...
  async function sendDataToAPI(e, _id) {
    ...
    await axios.post('http://localhost:8083/create-payment', {amount: totalCart*10}).then (async () => {
      ...
      await axios.post(`http://localhost:8000/orders/orderProduct/create`,
        {
          ...
          console.log("MEka wenawada")
          axios.delete(`http://localhost:8000/cart/delete/${product}/${userID.id}`).then(() =>{

          axios.patch(`http://localhost:8000/products/updateProductQty/${productid}`,{
